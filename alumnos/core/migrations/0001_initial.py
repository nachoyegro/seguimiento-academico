# Generated by Django 2.1.11 on 2020-02-26 16:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha', models.DateField(null=True)),
                ('forma_aprobacion', models.CharField(choices=[('EqE', 'Equivalencia equivalente'), ('PC', 'Promocion en otra carrera'), ('P', 'Promocion'), ('Eq', 'Equivalencia'), ('ExE', 'Examen equivalente'), ('Ex', 'Examen')], max_length=32, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ciclo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.Ciclo')),
                ('materia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Materia')),
                ('obligatorias', models.ManyToManyField(related_name='obligatoria_de', to='core.MateriaEnPlan')),
            ],
        ),
        migrations.CreateModel(
            name='PlanDeEstudio',
        ...
        migrations.AddField(
            model_name='materiaenplan',
            name='recomendadas',
            field=models.ManyToManyField(related_name='recomendada_de', to='core.MateriaEnPlan'),
        ),
        migrations.AddField(
