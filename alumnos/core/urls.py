...
urlpatterns = [
    ...
    path(r'api/v2/carreras/<str:codigo_carrera>/alumnos/', AlumnosDeCarreraView.as_view()),
    path(r'api/v2/carreras/<str:codigo_carrera>/planes/<int:plan_anio>/', MateriasEnPlanView.as_view()),
