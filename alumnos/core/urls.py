...
urlpatterns = [
    ...
    path(r'api/carreras/<str:codigo_carrera>/cantidad-graduados/<int:anio>/',
         CantidadGraduadosView.as_view()),
    path(r'api/carreras/<str:codigo_carrera>/cantidad-cursantes/',
         CantidadCursantesView.as_view()),
    path(r'api/carreras/<str:codigo_carrera>/cantidad-cursantes/<int:anio>/',
         CantidadCursantesView.as_view()),
    path(r'api/carreras/<str:codigo_carrera>/cantidad-ingresantes/',
         CantidadIngresantesView.as_view()),
    path(r'api/carreras/<str:codigo_carrera>/cantidad-ingresantes/<int:anio>/',
         CantidadIngresantesView.as_view()),
